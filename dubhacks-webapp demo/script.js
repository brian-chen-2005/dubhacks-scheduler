// Define the Hugging Face API URL for the LLaMA 2 model (replace this with the exact model endpoint you are using)
// const apiUrl = '----';
...
// async function getLlama2Response(prompt) {
//   try {
...
//         inputs: prompt,
//         parameters: {
//           max_new_tokens: 500,  // Optional: limit the number of tokens generated
...
//     // Check if the response is an array and contains the generated text
...
//     }
//   } catch (error) {
//     console.error("Error fetching LLaMA 2 response:", error);
//     throw error;
//   }
// }

//above all LLaMA code commented out for demo purposes
...
document.getElementById('sendButton').addEventListener('click', function() {
  ...
  if (userMessage.trim() !== '') {
    ...
    //   const llamaResponse = await getLlama2Response(userMessage);

    //   botMessageElement.textContent = llamaResponse;
    //   chatHistory.appendChild(botMessageElement);
      
    //   parseSchedule(String(llamaResponse));
    ...
    //   const botMessageElement = document.createElement('div');
    //   botMessageElement.classList.add('bot-message');
    //   botMessageElement.textContent = "Error fetching LLaMA 2 response";
    //   chatHistory.appendChild(botMessageElement);
    // }
    // above llama code commented out for demo purposes
